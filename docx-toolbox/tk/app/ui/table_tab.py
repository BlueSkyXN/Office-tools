...
class TableTab(ttk.Frame):
    ...
    def _build_ui(self) -> None:
        ...
        self._include_marked = tklib.BooleanVar(value=False)
        ttk.Checkbutton(opts_frame, text="包含已标记表格文件",
                        variable=self._include_marked).grid(
    ...
    def _get_options(self) -> dict:
        return {"include_marked": self._include_marked.get()}
    ...
    def _start(self) -> None:
        ...
        self._log.append(f"表格提取任务已提交: {input_path}")
