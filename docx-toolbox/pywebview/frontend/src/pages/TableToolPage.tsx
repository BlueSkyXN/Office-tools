...
import type { TableOptions, TaskInfo } from '../types'
...
export default function TableToolPage() {
  ...
  return (
    <div>
      <h1 className="page-title">表格提取与导出</h1>
      ...
      <div className="card" style={{ maxWidth: 600 }}>
        ...
        <div style={{ marginTop: 16 }}>
          ...
          <label className="checkbox-row">
            <input
              type="checkbox"
              checked={options.include_marked}
              onChange={() => setOptions((p) => ({ ...p, include_marked: !p.include_marked }))}
            />
            包含已标记表格文件
          </label>
        </div>
